...
public class FileImportHelperTaskMaterial
{
    ...
    public PBS_Metallic finalMaterial;
    ...
    public FileImportHelperTaskMaterial(string myID, string file, UnityProjectImporter importer)
    {
        ...
        finalMaterial = matslot.GetComponentOrAttach<PBS_Metallic>();
        this.myID = myID;
    }
    ...
    public async Task<PBS_Metallic> runImportFileMaterialsAsync()
    {
    ...
    private async Task<PBS_Metallic> ImportFileMaterial()
    {
        ...
        for (int i=0; i < lines.Length;i++ )
        {
            ...
            if (!inTextureBlock || lines[i].Contains('}')) continue;
